          ...
          <div className="relative z-10">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8 mb-10">
              ...
              <div>
                ...
                <p className="text-slate-400 font-sans text-lg max-w-sm">
                  Cùng trao đổi về Marketing và tạo ra những giá trị mới!
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              {/* Social Icons using SVGs styled for Dark Theme */}
              <a href="#" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:bg-[#0077b5] hover:border-transparent transition-all duration-300">
