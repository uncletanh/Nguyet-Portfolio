...
import { Mail, MapPin, Send, Coffee, Phone } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col gap-6 md:gap-8 mb-12">
              ...
              <a href="tel:0973840064" className="flex items-center gap-4 md:gap-6 group w-full sm:w-fit">
                <div className="w-12 h-12 md:w-14 md:h-14 shrink-0 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-300 group-hover:text-[#3B82F6] group-hover:border-[#3B82F6]/50 group-hover:shadow-[0_0_20px_rgba(59,130,246,0.2)] transition-all duration-300">
              ...
              <div className="flex items-center gap-4 md:gap-6 group w-full sm:w-fit">
                <div className="w-12 h-12 md:w-14 md:h-14 shrink-0 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-300 group-hover:text-[#FF6B5A] group-hover:border-[#FF6B5A]/50 transition-all duration-300">
            ...
            <div className="flex gap-4 mt-8">
              {/* Facebook Icon */}
              <a href="https://www.facebook.com/helloiamnguyet" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:bg-[#1877F2] hover:border-transparent transition-all duration-300">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              {/* Instagram Icon */}
              <a href="https://www.instagram.com/lm_nguyet/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:bg-gradient-to-tr hover:from-yellow-400 hover:via-pink-500 hover:to-purple-500 hover:border-transparent transition-all duration-300">
